...
import com.yukoon.bargain.realms.UserRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(@Qualifier("securityManager") org.apache.shiro.mgt.SecurityManager manager){
		...
		filterChainDefinitionMap.put("/bargain/**","anon");
		...
		filterChainDefinitionMap.put("/share_QRimages/**","anon");
		filterChainDefinitionMap.put("/basic_images/**","anon");
		...
		filterChainDefinitionMap.put("/getsharedetails","anon");
