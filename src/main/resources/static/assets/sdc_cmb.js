...
function RedirectUrl(adcolumn, adname, adurl, url)
{		
	...
	dcsMultiTrack('DCS.dcssip',ip,'DCS.dcsuri',adurl,'WT.ti',ADName,'DCSext.wt_click',"click", 'DCSext.wt_cname', ADColumn, 'DCSext.wt_otype', "advtype", 'DCSext.wt.domain', ip, 'DCSext.wt_ptitle', pagetitle);							
	window.open(url);
}
